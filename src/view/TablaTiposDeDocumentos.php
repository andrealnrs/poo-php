    ...
    function render($llenarTabla){
        ...
        foreach($llenarTabla as $filaTabla){
            ...
            <tr>
                ...
                <td>
                <button type="button" class="btn btn-danger eliminar-documento"><i class="bi bi-trash"></i></button>
                <button type="button" class="btn btn-info editar-documento"><i class="bi bi-pencil-square"></i></button>
                </td>               
            </tr>
            ';
        }

...
function activarBotonesEliminar(){
    let botonesEliminar = document.querySelectorAll(".eliminar-usuario");
...
function eliminarRegistro(){
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            requestConsultaEliminar.open('POST', 'http://localhost/poo/src/controller/UsuarioEliminarControlador.php', true);
